...
public class ArraySolution {
    ...
    @Test
    public int testRemoveDuplicates() {
        Assert.assertEquals(5, removeDuplicates(new int[]{1, 1, 2, 2, 3}));
        Assert.assertEquals(7, removeDuplicates(new int[]{0, 0, 1, 1, 2, 3, 3}));
    }
}
